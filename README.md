...
Just paste this into a terminal:
    ...
    curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | bash
...
**2.)** Download and unpack ievms:
   ...
   * To install specific IE versions (IE7, IE9 and EDGE only for example) use:
        ...
        curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | env IEVMS_VERSIONS="7 9 EDGE" bash
...
To specify where the VMs are installed, use the `INSTALL_PATH` variable:
    ...
    curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | env INSTALL_PATH="/Path/to/.ievms" bash
...
environment variable. For example, you can set a download speed limit:
    ...
    curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | env CURL_OPTS="--limit-rate 50k" bash
...
environment variable `REUSE_XP` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | env REUSE_XP="no" bash
...
variable `REUSE_WIN7` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/kazu69/ievms/fix_IE_Edge_Hash/ievms.sh | REUSE_WIN7="no" bash
